package cn.sanshaoxingqiu.ssbm.widget.countdowntimer;
...
class BaseCountdown {
    ...
    private static final String DEFAULT_SUFFIX_DAY = "天";
    private static final float DEFAULT_SUFFIX_LR_MARGIN = 1; // dp
        ...
        if (isShowDay) {
            if (hasSetSuffixDay) {
                ...
                if (!isSuffixNull) {
                    ...
                    mSuffixDay = DEFAULT_SUFFIX_DAY;
                    mSuffixDayTextWidth = mDefSuffixTextWidth * 4;
                }
            }
        } else {
