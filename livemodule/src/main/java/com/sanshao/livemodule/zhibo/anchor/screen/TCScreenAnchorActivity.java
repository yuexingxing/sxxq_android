package com.sanshao.livemodule.zhibo.anchor.screen;
...
import com.sanshao.livemodule.zhibo.anchor.screen.widget.FloatingCameraView;
import com.sanshao.livemodule.zhibo.anchor.screen.widget.FloatingView;
...
public class TCScreenAnchorActivity extends TCBaseAnchorActivity {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_return) {//悬浮球返回主界面按钮
...
//                getApplicationContext().startActivity(intent);
        ...
        } else if (id == R.id.btn_camera) {//camera悬浮窗
