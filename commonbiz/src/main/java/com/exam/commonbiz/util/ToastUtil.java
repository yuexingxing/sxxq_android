...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if (BasicApplication.app != null) {
            if (toast == null) {
                toast = Toast.makeText(BasicApplication.app, msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            ...
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(BasicApplication.app, 64));
            toast.show();
        }
    }
    ...
    public static void showLongToast(String msg) {
        if (BasicApplication.app != null) {
            if (toast == null) {
                toast = Toast.makeText(BasicApplication.app, msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(BasicApplication.app, 64));
